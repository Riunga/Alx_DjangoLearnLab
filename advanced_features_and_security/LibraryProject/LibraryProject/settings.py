...
SECRET_KEY = 'django-insecure-64=%ipa1by@3vr@6j53$zosnz(drmb#-^3=i&m8i5dc)8$_1pw'
...
DEBUG = False  # Set to False to prevent displaying sensitive debug info in production
...
# Enforce cookies over HTTPS in production
...
# Enforce HTTPS across all subdomains and preload HSTS
